    ...
    <div className="flex flex-col gap-6">
      <header className="flex justify-between items-end mb-2">
        ...
        <div className="flex gap-4 items-center">
          ...
          <button className="px-5 py-2.5 bg-primary text-white rounded-full text-[13px] font-medium shadow-[0_4px_12px_rgba(1,45,29,0.2)]">Export report</button>
        </div>
      </header>
      ...
      <div className="grid grid-cols-12 auto-rows-auto gap-5">
        ...
        <div className="col-span-3 bg-surface rounded-[var(--radius-lg)] p-6 shadow-[var(--shadow-soft)] flex flex-col">
          ...
          <div className="flex-1 flex justify-center items-center py-5">
            <div className="w-[140px] h-[140px] rounded-full bg-[conic-gradient(var(--color-primary)_0%_68%,#D1E68C_68%_88%,var(--color-background)_88%_100%)] flex items-center justify-center">
              <div className="w-[100px] h-[100px] bg-surface rounded-full flex flex-col items-center justify-center shadow-[inset_0_2px_8px_rgba(0,0,0,0.05)]">
                <span className="text-[28px] font-bold text-primary leading-none">98</span>
        ...
        {/* Tasks List Widget */}
        <div className="col-span-4 bg-surface rounded-[var(--radius-lg)] p-6 shadow-[var(--shadow-soft)] flex flex-col">
          <div className="flex justify-between items-center mb-6">
        ...
        <div className="col-span-5 bg-surface rounded-[var(--radius-lg)] p-6 shadow-[var(--shadow-soft)] flex flex-col">
          <div className="flex justify-between items-center mb-6">
            <div>
              <h3 className="text-[16px] font-semibold text-text-primary m-0">Transaction Snapshot</h3>
              <p className="text-[12px] text-text-tertiary mt-1 mb-0">Rentals completed this week</p>
            </div>
            <div className="flex bg-background p-1 rounded-full">
              <span className="px-4 py-1.5 text-[11px] font-medium text-text-secondary rounded-full cursor-pointer bg-primary !text-white">Weekly</span>
              <span className="px-4 py-1.5 text-[11px] font-medium text-text-secondary rounded-full cursor-pointer">Monthly</span>
              <span className="px-4 py-1.5 text-[11px] font-medium text-text-secondary rounded-full cursor-pointer">Annually</span>
            </div>
          </div>
          <div className="flex-1 relative min-h-[180px] bg-[linear-gradient(180deg,rgba(209,230,140,0.2)_0%,rgba(255,255,255,0)_100%)] rounded-[var(--radius-md)] mt-4 overflow-hidden">
            <div className="absolute top-[40%] left-0 w-full h-[2px] bg-primary-light before:absolute before:-top-5 before:left-[10%] before:w-[40%] before:h-10 before:border-2 before:border-primary-light before:border-b-0 before:rounded-t-[100px] after:absolute after:top-0 after:left-[50%] after:w-[40%] after:h-10 after:border-2 after:border-primary-light after:border-t-0 after:rounded-b-[100px]"></div>
            <div className="absolute top-[calc(40%-20px)] left-[30%] w-3 h-3 bg-surface border-2 border-primary rounded-full shadow-[0_0_0_4px_rgba(1,45,29,0.1)]">
              <div className="absolute -top-[45px] left-1/2 -translate-x-1/2 bg-surface px-3 py-1.5 rounded-lg text-[11px] font-semibold shadow-[var(--shadow-hover)] whitespace-nowrap text-center text-text-primary">22 rentals<br/><span className="font-normal text-text-tertiary text-[10px]">Thursday</span></div>
            </div>
          </div>
        </div>

        {/* Recent Activity / Users Widget */}
        <div className="col-span-12 bg-surface rounded-[var(--radius-lg)] p-6 shadow-[var(--shadow-soft)] flex flex-col">
          <div className="flex justify-between items-center mb-6">
            <div>
