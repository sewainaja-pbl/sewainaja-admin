...
import { LayoutGrid, Users, Receipt, MessageSquareWarning, Tags, Package, Bell, Settings, LogOut, AlertOctagon, Wallet } from 'lucide-react';
    ...
    <aside className="fixed left-6 top-5 z-[100] hidden lg:flex flex-col justify-between items-start w-[72px] h-[calc(100vh-40px)] overflow-hidden transition-[width] duration-300 ease-[cubic-bezier(0.4,0,0.2,1)] hover:w-[180px] group">
      ...
      <nav className="bg-surface rounded-[36px] p-2.5 flex flex-col gap-2 shadow-[var(--shadow-soft)] w-full">
        ...
        <Link 
          ...
          className={`w-full h-[52px] flex items-center justify-start px-[14px] rounded-[26px] transition-all duration-300 ease-[cubic-bezier(0.4,0,0.2,1)] whitespace-nowrap ${isActive('/dashboard/transactions') ? 'bg-primary !text-[#FFFFFF] shadow-[0_4px_12px_rgba(1,45,29,0.2)]' : 'text-text-tertiary bg-transparent hover:text-primary hover:bg-background'}`} 
          title="Transactions"
        >
          <div className="flex items-center justify-center shrink-0">
            <Receipt size={22} strokeWidth={2} />
          </div>
          <span className="ml-4 text-[14px] font-medium opacity-0 transition-opacity duration-200 ease-in pointer-events-none group-hover:opacity-100 group-hover:delay-100">Transactions</span>
        </Link>
        <Link 
        ...
        <Link
          ...
          className={`w-full h-[52px] flex items-center justify-start px-[14px] rounded-[26px] transition-all duration-300 ease-[cubic-bezier(0.4,0,0.2,1)] whitespace-nowrap ${isActive('/dashboard/categories') ? 'bg-primary !text-[#FFFFFF] shadow-[0_4px_12px_rgba(1,45,29,0.2)]' : 'text-text-tertiary bg-transparent hover:text-primary hover:bg-background'}`}
          title="Categories"
        >
          <div className="flex items-center justify-center shrink-0">
            <Tags size={22} strokeWidth={2} />
          </div>
          <span className="ml-4 text-[14px] font-medium opacity-0 transition-opacity duration-200 ease-in pointer-events-none group-hover:opacity-100 group-hover:delay-100">Categories</span>
        </Link>
        <Link
          href="/dashboard/items"
          className={`w-full h-[52px] flex items-center justify-start px-[14px] rounded-[26px] transition-all duration-300 ease-[cubic-bezier(0.4,0,0.2,1)] whitespace-nowrap ${isActive('/dashboard/items') ? 'bg-primary !text-[#FFFFFF] shadow-[0_4px_12px_rgba(1,45,29,0.2)]' : 'text-text-tertiary bg-transparent hover:text-primary hover:bg-background'}`}
          title="Items"
        >
          <div className="flex items-center justify-center shrink-0">
            <Package size={22} strokeWidth={2} />
          </div>
          <span className="ml-4 text-[14px] font-medium opacity-0 transition-opacity duration-200 ease-in pointer-events-none group-hover:opacity-100 group-hover:delay-100">Items</span>
        </Link>
        <Link
          href="/dashboard/reports"
          className={`w-full h-[52px] flex items-center justify-start px-[14px] rounded-[26px] transition-all duration-300 ease-[cubic-bezier(0.4,0,0.2,1)] whitespace-nowrap ${isActive('/dashboard/reports') ? 'bg-primary !text-[#FFFFFF] shadow-[0_4px_12px_rgba(1,45,29,0.2)]' : 'text-text-tertiary bg-transparent hover:text-primary hover:bg-background'}`}
          title="Reports"
        >
          <div className="flex items-center justify-center shrink-0">
            <AlertOctagon size={22} strokeWidth={2} />
          </div>
          <span className="ml-4 text-[14px] font-medium opacity-0 transition-opacity duration-200 ease-in pointer-events-none group-hover:opacity-100 group-hover:delay-100">Reports</span>
        </Link>
        <Link
          href="/dashboard/withdrawals"
          className={`w-full h-[52px] flex items-center justify-start px-[14px] rounded-[26px] transition-all duration-300 ease-[cubic-bezier(0.4,0,0.2,1)] whitespace-nowrap ${isActive('/dashboard/withdrawals') ? 'bg-primary !text-[#FFFFFF] shadow-[0_4px_12px_rgba(1,45,29,0.2)]' : 'text-text-tertiary bg-transparent hover:text-primary hover:bg-background'}`}
          title="Withdrawals"
        >
          <div className="flex items-center justify-center shrink-0">
            <Wallet size={22} strokeWidth={2} />
          </div>
          <span className="ml-4 text-[14px] font-medium opacity-0 transition-opacity duration-200 ease-in pointer-events-none group-hover:opacity-100 group-hover:delay-100">Withdrawals</span>
        </Link>
        <Link 
